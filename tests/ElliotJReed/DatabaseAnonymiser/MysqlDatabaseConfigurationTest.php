...
class MysqlDatabaseConfigurationTest extends DatabaseTestCase
{
    ...
    public function testItThrowsExceptionByDefaultIfForeignKeyChecksAreEnabled(): void
    {
        ...
        $this->pdo->exec(
            ...
            CREATE TABLE example_table (example_column INT(1) PRIMARY KEY) ENGINE=INNODB;
            INSERT INTO example_table (example_column) VALUES (1);
            CREATE TABLE example_second_table (example_column INT(1), ref_column INT(1), INDEX ref_index (ref_column), FOREIGN KEY(ref_column) REFERENCES example_table(example_column))) ENGINE=INNODB;
